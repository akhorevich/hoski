...
import app.hoski.ActivityMain;
import app.hoski.ActivityPlaceDetail;
import app.hoski.R;
import app.hoski.adapter.AdapterPlaceGrid;
import app.hoski.data.AppConfig;
import app.hoski.data.DatabaseHandler;
import app.hoski.data.SharedPref;
import app.hoski.data.ThisApplication;
import app.hoski.loader.ApiClientLoader;
import app.hoski.model.ApiClient;
...
public class FragmentCategory extends Fragment {
    ...
    public static String TAG_CATEGORY   = "app.hoski.tagCategory";
