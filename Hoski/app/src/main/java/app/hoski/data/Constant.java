...
public class Constant {
	...
	// for map zoom
	public static final double city_lat = 55.166815;
	public static final double city_lng = 61.430509;

	// for gcm
	public static final String PROJECT_API_NUMBER = "1073910127456";

	/** ------------------- EDIT THIS WITH YOURS ------------------------- */

	private static String HOST_URL = "http://hoski.ru";
	private static String WEB_PATH = "/men";
