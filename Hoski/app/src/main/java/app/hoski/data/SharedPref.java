...
public class SharedPref {
    ...
    public static final String GCM_PREF_KEY = "app.hoski.data.GCM_PREF_KEY";
    public static final String SERVER_FLAG_KEY = "app.hoski.data.SERVER_FLAG_KEY";
    public static final String THEME_COLOR_KEY = "app.hoski.data.THEME_COLOR_KEY";

    // need refresh
    public static final String REFRESH_PLACES = "app.hoski.data.REFRESH_PLACES";
