...
import app.hoski.adapter.AdapterFullScreenImage;
import app.hoski.utils.Tools;

public class ActivityFullScreenImage extends AppCompatActivity {

    public static final String EXTRA_POS   = "app.hoski.EXTRA_POS";
    public static final String EXTRA_IMGS  = "app.hoski.EXTRA_IMGS";
